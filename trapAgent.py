...
subprocess.call([ruta_exe, "-v:1", "-c:public", "-r:172.16.239.20", "-to:1.3.6.1.6.3.1.1.4.1.0", "-del:''", "-eo:1.3.6.1.4.1.8072.3.2.10", "-vid:1.3.6.1.6.3.1.1.5.1", "-vtp:str", "-val:'1'", "-p:1620"])
